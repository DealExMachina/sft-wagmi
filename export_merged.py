...
PROFILE_CONFIG = {
    "small": {
        ...
        "hub_merged_repo": os.environ.get("SMALL_HUB_MERGED_REPO", "jeanbaptdzd/wagmi-qwen2.5-1.5b-sft-merged"),
    ...
    "auth": {
        ...
        "hub_merged_repo": os.environ.get("AUTH_HUB_MERGED_REPO", "jeanbaptdzd/wagmi-qwen2.5-14b-sft-merged"),
